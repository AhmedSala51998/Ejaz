                        ...
                        <form id="CompleteRegister" method="post" action="{{route('register_action')}}" class="row">
                            ...
                            <div class="col-12 p-2 text-center">
                                ...
                                <div class="vCode " id="vCode" >
                                    <input value="" id="vCodeIdFirst" onkeypress="isNumber(evt)"  type="number" class="vCode-input mx-1" maxlength="1">
                                    <input value="" type="number"  onkeypress="isNumber(evt)"  class="vCode-input mx-1" maxlength="1">
                                    <input value="" type="number"   onkeypress="isNumber(evt)" class="vCode-input mx-1" maxlength="1">
                                    <input value="" type="number"  onkeypress="isNumber(evt)"  class="vCode-input mx-1" maxlength="1">
                                </div>
